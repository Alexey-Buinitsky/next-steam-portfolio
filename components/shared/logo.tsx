...
export const Logo: React.FC<Props> = ({ className, title, subtitle, icon: Icon, image, showAvatar = false, avatarName, avatarEmail }) => {
	return (
		<div className={cn('flex items-center gap-2 2k:gap-2.5 4k:gap-4 8k:gap-8', className)}>
			<div className="relative flex shrink-0 overflow-hidden rounded-lg">
				{showAvatar ? (
					...
					<Icon size={48} className='2k:size-16 4k:size-24 8k:size-48' />
				) : null}
			</div>

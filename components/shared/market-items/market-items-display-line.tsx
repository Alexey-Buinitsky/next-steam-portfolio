            ...
            <div className='mx-auto xl:w-4/5'>
                ...
                <div className="flex flex-col gap-2 mb-6">
                    {data?.assets.map((item) => (
                        <div className="flex items-center w-full border rounded py-0.5 pl-2 pr-4 sm:px-4 hover:shadow-md transition-shadow dark:hover:shadow-gray-500 dark:hover:shadow-sm">
                            <Image
